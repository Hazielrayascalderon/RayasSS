...
if (!in_array($rol, ['Administrador', 'Coordinación', 'Coordinaci贸n'])) {
    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="menuNavegacion">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1 mt-3 mt-lg-0">
                ...
                <?php if (in_array($_SESSION['rol'], ['Administrador', 'Coordinación', 'Coordinaci贸n'])) { ?>
                    <li class="nav-item"><a class="nav-link active px-3" href="tablon_monitoreo.php"><i class="bi bi-graph-up me-2"></i>Monitoreo</a></li>
...
<div class="container-fluid px-4">
    <h4 class="fw-bold text-dark mb-4"><i class="bi bi-grid-1x2-fill me-2" style="color: var(--guinda-base);"></i>Indicadores de Productividad Institucional (Dirección)</h4>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="pe-4" style="width: 20%">Progreso Validados</th>
                    </tr>
                </thead>
                <tbody>
