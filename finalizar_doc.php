...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (!isset($_FILES['archivo_respuesta']) || $_FILES['archivo_respuesta']['error'] !== UPLOAD_ERR_OK) {
            throw new Exception("Debes adjuntar el PDF de la respuesta.");
        }
        ...
        $msg = !empty($_POST['redirect_msg']) ? $_POST['redirect_msg'] : 'respuesta_subida';
        header("Location: empleados_tareas.php?msg=" . urlencode($msg));
        exit;
